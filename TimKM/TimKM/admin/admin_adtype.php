...
elseif($_pgR['act'] == model_AdType::ACT_UPDATE)
{
	if (global_common::isCLogin())
	{
		...
		$resultID = $objAdType->update($adTypeID,$adTypeName,$width,$height,$numOfDay,$displayPage,$sharedItem,$price,$cityID,$status);
...
elseif($_pgR['act'] == model_AdType::ACT_SHOW_EDIT)
{
	...
	echo global_common::convertToXML($strMessageHeader, array('rs','AdTypeID','AdTypeName','Width','Height','NumOfDay','DisplayPage','SharedItem','Price','CityID','Status'), array(1,'AdTypeID','AdTypeName','Width','Height','NumOfDay','DisplayPage','SharedItem','Price','CityID','Status'),array(0,1,1,0,0,0,1,0,0,1,1));
	return ;
}
		...
		<div class="input-field-border input-field-content" >
				...
				<div class="div_admin_group_content_inside" style="width: 100%; top: -20px;">
				    <table id="tblPopUp" style="width: 100%;" border="0" cellpadding="2" cellspacing="0">
						...
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>SharedItem</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtSharedItem' name='txtSharedItem' value='' style='width: 49.5%;'  maxlength='20' type='text'></td>
						</tr>
						<tr>
