...
if ($_pgR["act"] == model_Menu::ACT_ADD)
{
	...
	if (global_common::isCLogin())
	{
		...
		$resultID = $objMenu->insert($menuID,$menuName,$link,$numOrder,$level,$parentID);
		if ($resultID)
		{
		...
		<div class="input-field-border input-field-content" >
				...
				<div class="div_admin_group_content_inside" style="width: 100%; top: -20px;">
				    <table id="tblPopUp" style="width: 100%;" border="0" cellpadding="2" cellspacing="0">
						...
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>Level</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtLevel' name='txtLevel' value='' style='width: 49.5%;'  maxlength='20' type='text'></td>
						</tr>
						<tr>
							<td width='110'><span style='cursor:default; font-family:inherit'>ParentID</span></td>
							<td width='10'><span class='forceFillForm'></span></td>
							<td width='567'><input id='txtParentID' name='txtParentID' value='' style='width: 49.5%;'  maxlength='60' type='text'></td>
						</tr>
                        </tbody>
                    </table>
				</div>
