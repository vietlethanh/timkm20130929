...
if ($_pgR["act"] == model_ArticleType::ACT_ADD)
{
	...
	if (global_common::isCLogin())
	{
		...
		$resultID = $objArticleType->insert($articleTypeID,$articleTypeName,$status,$level,$parentID);
		if ($resultID)
		{
...
elseif($_pgR['act'] == model_ArticleType::ACT_UPDATE)
{
	if (global_common::isCLogin())
	{
		...
		$resultID = $objArticleType->update($articleTypeID,$articleTypeName,$status,$level,$parentID);
...
elseif($_pgR['act'] == model_ArticleType::ACT_SHOW_EDIT)
{
	...
	echo global_common::convertToXML($strMessageHeader, array('rs','ArticleTypeID','ArticleTypeName','Status','Level','ParentID'), array(1,'ArticleTypeID','ArticleTypeName','Status','Level','ParentID'),array(0,1,1,1,0,1));
	return ;
}
